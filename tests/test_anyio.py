...
if sys.platform == "win32":
    ...
    PARAMS.append(pytest.param(("asyncio", {"use_uvloop": False}), id="asyncio"))
...
#     with pytest.raises(ClosedResolverError):
#         # ensure we call ClosedResolverError after this point in time...
#         await resolver.query("google.com", "A")
